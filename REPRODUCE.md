...
be promoted into the repository at camera-ready.
...
| TBD at camera-ready | `v1.0` | (unchanged) | adds `supplementary/`, `CITATION.cff`, `CHANGELOG.md`; uploaded to Zenodo and DOI minted |
